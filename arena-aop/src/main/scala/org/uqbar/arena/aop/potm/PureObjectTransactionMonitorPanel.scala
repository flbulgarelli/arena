...
class PureObjectTransactionMonitorPanel(parent: WindowOwner, model: ObjectTransactionImplObservable) 
	extends SimpleWindow[ObjectTransactionImplObservable](parent, model) {
